...
figure_2 = px.scatter(df, x='Revenue (USD millions)', y='Employees',
...
figure_4 = px.box(df, y='Revenue growth', title='Distribution of Revenue Growth')
