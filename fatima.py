...
# Check if the minimum revenue is greater than the maximum revenue and handle the error
if min_revenue > max_revenue:
    st.error("Error: Minimum revenue cannot be greater than maximum revenue. Please adjust the values.")
else:
